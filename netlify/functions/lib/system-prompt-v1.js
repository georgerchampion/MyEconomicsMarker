...
- The "improvement" field must contain exactly ONE improvement: the single highest-leverage change, tied to an exact sentence or paragraph. Never generic advice. First check the essay doesn't already contain what you're about to say is missing. This mark scheme does not require a formal intro/thesis/conclusion — marks come from KAA and Evaluation depth, not formatting — so never suggest adding those.
